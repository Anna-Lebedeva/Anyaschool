"""
Django settings for AnyaSchool project.
...
from AnyaSchool.secrets import DB_PASSWORD, DJANGO_SECRET_KEY
...
WSGI_APPLICATION = 'AnyaSchool.wsgi.application'
